...
import { observabilitySignalsCheck } from "./http/observability-signals";
...
export function buildRegistry(
  ...
  return {
    http: [
      ...
      // Plan 79: observability-signalen (G11 herdefinieerd) — passief,
      // hergebruikt de homepage-fetch (headers + HTML) + security.txt-Contact
      // als extra signaal. Altijd informatief (nooit medium/high).
